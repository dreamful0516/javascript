	...
	<head>
		...
		<script>
			...
			function fun3() {
				...
				img1.src = "${pageContext.request.contextPath}/resource/img/bg2.png";
			}
			
			function fun4() {
				var div2 = document.querySelector("#div2");
				div2.innerHTML += "<img src='${pageContext.request.contextPath}/resource/img/bg1.png'/>";
			}
		...
		<div style="margin-bottom:20px; padding:10px; border-top:1px solid black">
			<div>
				<form id="loginForm" name="loginForm" action="main.do" onsubmit="return fun5()">
					...
					<button style="margin-bottom:10px">사용자가 입력한 값 검사 후 전송</button>
				</form>
			</div>		
		</div>
	</body>
