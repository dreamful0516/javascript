...
<html>
	...
	<body>
		...
		<div>
			...
			<button onclick="fun3(3, 5)" class="btn btn-success btn-sm">fun3()을 이용해서 fun2() 호출</button>
			
			<a onclick="return fun4(null)" href="main.do" class="btn btn-primary btn-sm">메인 화면</a>
